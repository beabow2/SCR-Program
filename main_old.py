...
def SCR_resp(rise_begin, rise_end, max_rise_time, situation, target, display_window, time_step=TIME_STEP):
    """
    :param rise_begin:
    :param rise_end:
    :param max_rise_time:
...
def adjust_parameters():
    ...
    confirm_btn = tk.Button(param_window, text="Apply", command=lambda : apply_parameters(rise_begin.get(), rise_end.get(), display_window.get(), max_rise_time.get(), target.get()))
    confirm_btn.pack()
